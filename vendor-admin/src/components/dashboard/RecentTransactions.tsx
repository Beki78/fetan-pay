  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/payments" className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors">
          View all
        </Link>
      </div>
        ...
        <div className="overflow-x-auto">
          <Table>
            <TableHeader className="border-b border-gray-700">
              <TableRow className="bg-gray-800/80">
                <TableCell
                  isHeader
                  className="px-5 py-3.5 font-semibold text-gray-400 text-start text-sm uppercase tracking-wide"
                >
                  CODE
                </TableCell>
                <TableCell
            ...
            <TableBody className="divide-y divide-gray-700">
              {mockTransactions.length === 0 ? (
                ...
                mockTransactions.map((transaction) => (
                  <TableRow
                    key={transaction.id}
                    className="bg-gray-800/50 hover:bg-gray-800/70 transition-colors border-b border-gray-700/50"
                  >
                    ...
                    <TableCell className="px-5 py-4 text-gray-300 font-medium">
