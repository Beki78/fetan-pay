...
import { useGetNotificationsQuery, useMarkAllAsReadMutation, useMarkAsReadMutation } from "@/lib/services/notificationsServiceApi";
import { NotificationType, NotificationPriority } from "@/lib/services/notificationsServiceApi";
...
export default function NotificationsPage() {
  ...
  const handleNotificationClick = (notification: any) => {
    ...
    if (notification.type === 'MERCHANT_REGISTRATION') {
      ...
      console.log('Merchant-admin notification page click:', { 
