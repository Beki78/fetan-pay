...
import { Notification, NotificationType, NotificationPriority, useMarkAsReadMutation } from "@/lib/services/notificationsServiceApi";
...
const NotificationItem: React.FC<NotificationItemProps> = ({ notification, onMarkAsRead, onItemClick }) => {
  ...
  const handleMarkAsRead = async () => {
    ...
    if (notification.type === 'MERCHANT_REGISTRATION') {
      ...
      console.log('Merchant-admin notification data:', { 
