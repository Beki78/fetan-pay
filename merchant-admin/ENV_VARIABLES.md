# Merchant Admin Environment Variables

This document describes the environment variables required for the Merchant Admin application.

## Required Environment Variables

Create a `.env.local` file in the root of the `merchant-admin` directory with the following variables:
...
# Production: https://merchant.fetanpay.et
# Development: http://localhost:3001
NEXT_PUBLIC_FRONTEND_URL=https://merchant.fetanpay.et

# Payment page URL (for transaction links)
# Production: https://fetanpay.et
# Development: http://localhost:3000
NEXT_PUBLIC_PAYMENT_PAGE_URL=https://fetanpay.et
...
NEXT_PUBLIC_PAYMENT_PAGE_URL=http://localhost:3000
...
- The `PAYMENT_PAGE_URL` is used for generating payment links
