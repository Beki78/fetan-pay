...
- **[API Quick Start](/api/quickstart)** - Get started with the API in minutes
- **[API Overview](/api/overview)** - Introduction to the FetanPay API
- **[Authentication](/api/authentication)** - How to authenticate API requests
- **[Payments API](/api/payments)** - Verify payments and manage transactions
- **[Webhooks](/api/webhooks)** - Receive real-time payment notifications
- **[API Keys Management](/api/api-keys)** - Manage your API keys programmatically
