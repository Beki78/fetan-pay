...
This document describes the environment variables required for the Admin application.

## Required Environment Variables

Create a `.env.local` file in the root of the `admin` directory with the following variables:
...
# Production: https://admin.fetanpay.et
# Development: http://localhost:3000
NEXT_PUBLIC_FRONTEND_URL=https://admin.fetanpay.et
