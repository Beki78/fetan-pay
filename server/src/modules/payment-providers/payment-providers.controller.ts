...
export class PaymentProvidersController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieves a list of available payment providers. Can be filtered by status.',
  })
  @ApiQuery({
    name: 'status',
    required: false,
  ...
  @ApiOperation({
    ...
    description: 'Creates or updates a payment provider configuration. Requires admin authentication.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Deletes a payment provider configuration. Requires admin authentication.',
  })
  @ApiParam({
    name: 'code',
